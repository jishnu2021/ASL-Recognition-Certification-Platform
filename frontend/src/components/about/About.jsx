...
const About = () => {
    return (
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4" style={{paddingTop:0,width:'85%',textAlign:'center'}}>
            <div className="lg:w-10/12 w-full">
               <h1 style={{fontFamily:700,fontSize:'3rem',textAlign:'center',color:'black'}}><b>About</b></h1>
